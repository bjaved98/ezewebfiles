...
function sticky_menu_active() {
    if (jQuery('.sticky-header').length) {
        jQuery('.sticky-header').each(function () {
            const obj = jQuery(this); // The sticky header element
            const header = obj.next('.sticky-header-on'); // Regular header
            ...
            obj.addClass('sticky-active'); // Add sticky-active class to the sticky header
            header.hide(); // Hide the non-sticky header
        });
    }
}
